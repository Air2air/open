import{s as o,B as a,h as i,i as n,b as d,F as r,j as e}from"./bannerCSS-312176e4.js";import{C as p}from"./callOut-654a38a1.js";import{M as u,V as g,e as b,S as l}from"./index-c1d139ea.js";import{R as m}from"./rowButton-ef75ab71.js";import"./index-e7ce6b91.js";import"./titleCallout-9530f058.js";import"./buttonCSS-4aba25bd.js";const f=({pageImage:t,overlayOpacity:s,overlayColor:c})=>{const h="url(/images/content/"+t+")";return d(r,{children:[e("div",{className:"animate__animated animate__fadeIn animate__delay-0s animate__slower",children:e(v,{style:{backgroundImage:h}})}),e(x,{overlayOpacity:s,overlayColor:c})]})},x=({overlayOpacity:t,overlayColor:s})=>e(r,{children:e(y,{style:{opacity:t,background:s}})}),v=o.div`
  position: absolute;
  top: 0;
  left: 0;
  margin: 0 auto;
