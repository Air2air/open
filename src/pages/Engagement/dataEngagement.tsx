export const dataEngagement = [
  {
    ...
    desc: "We advise Healthcare AI companies in:<ul><li>Technical</li><li>Clinical</li><li>Product/Market</li><li>Regulatory/Legal</li><li>Strategy/Business Dev</li></ul> We'll have an initial conversation to identify which you need and when.  Each of these project tracks follow the timelines and milestones as defined in our process.",
    backgroundColor: 2,
  },
