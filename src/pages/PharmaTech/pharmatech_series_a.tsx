...
const title = `PharmaTech Series A Stage`;
...
const PharmaTechSeriesAPage = ({ nextPath, nextName, section }) => {
  return (
    <>
<div className="wrapper">
{section && <div className="chip pharma">
...
export default PharmaTechSeriesAPage;
