  ...
  return (
    <>
      <BannerImage
        ...
        pageDescription="Eleven is a multidisciplinary team of physicians, scientists, engineers, and enterprisers who combine their experience to define a path forward for leading companies building the future of digital health and clinical machine learning."
        pageImage={pageImage}
        overlayOpacity={0.7}
