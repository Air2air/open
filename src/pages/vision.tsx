  ...
  return (
    <>
      ...
      <Callout
        ...
        <p>Eleven was <b>designed</b> with this historical perspective in mind, founded by a multidisciplinary team of physicians, scientists, and engineers who combine their experience to define a path forward for leading companies building the future of digital health and clinical machine learning.</p>'
