export const dataPracticeAreas = [
  {
    ...
    title: "x = Clinical",
    label: "Clinical",
    text: "The world's foremost clinical talent guides Eleven's digital health ventures to the best possible outcomes. Your Chief Medical AI Officer C{m}AIO offers deep technical and clinical support for broader consumer health sector landscape (e.g., patient engagement, wearables, digital health and wellness).",
    color: "#FFFFFF",
