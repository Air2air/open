...
interface ICalloutMouseoverProps {
  calloutTitle: string;
  calloutText: string;
  calloutVideo?: string;
...
export const CalloutMouseOver = (props: ICalloutMouseoverProps) => {
  const {
    calloutTitle,
    calloutText,
    backgroundColor,
...
const CalloutMouseoverWrapper = styled.div`
  position: relative;
  top: 0;
  display: flex;
...
export default CalloutMouseOver;
